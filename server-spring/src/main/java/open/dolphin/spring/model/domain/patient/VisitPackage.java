...
@AllArgsConstructor
@Builder
public class VisitPackage extends InfoModel {
    ...
    // Active病名
    // TODO: Uncomment when RegisteredDiagnosisModel is moved to diagnosis domain
    // private List<RegisteredDiagnosisModel> disease;

    // アレルギー
    // TODO: Uncomment when AllergyModel is moved to diagnosis domain
